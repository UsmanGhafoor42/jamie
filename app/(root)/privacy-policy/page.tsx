...
const page = () => {
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 py-10 max-w-7xl mx-auto layout">
      ...
      <section className="space-y-4 text-gray-800">
        ...
        <p>
          ...
          an order, Open a Support Ticket or enter information on our site.
        </p>
        ...
        <p>
          However, you will still be able to place orders over the telephone by
          contacting customer service.
        </p>

        <h2 className="text-2xl font-semibold mt-8">Third-party disclosure</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8">Google</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8">CAN SPAM Act</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8">Contacting Us:</h2>
        <p>
          If there are any questions regarding this privacy policy, you may
          contact us using the contact information on the website.
        </p>
      </section>
    </div>
  );
